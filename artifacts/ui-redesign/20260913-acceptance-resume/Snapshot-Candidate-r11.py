...
repo=root.parents[2]
candidate=root/'candidate-1.8.8-r11'
installer=root/'installer-1.8.8-r11/EtpReportingEngine-Setup-1.8.8-x64.exe'
...
(root/'candidate-r11-receipt.json').write_text(json.dumps(receipt,indent=2),encoding='utf-8')
