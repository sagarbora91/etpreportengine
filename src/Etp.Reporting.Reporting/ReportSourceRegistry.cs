...
public static class ReportSourceRegistry
{
    ...
    [
        ...
        new("RPT-STOCK-TITAN","Titan World Closing Stock",["CLOSING_STOCK","STOCK_LEDGER"],
            ...
            ["DISPLAY_STOCK","BACKSTOCK","DEFECTIVE_STOCK","Y_LOCATION_STOCK","PHYSICAL_STOCK","OPERATIONAL_REMARK"],
            ["physical_quantity","system_quantity","difference"],"Physical stock minus ETP closing snapshot, with ledger-to-snapshot control.",
            ["Physical-location composition is operational input and is never inferred from ETP."]),
        ...
        new("RPT-STAFF","Staff / CRO Performance",["R013","R025"],
            ...
            ["SALES_TARGET"],["achievement","ranking","contribution","UPT","ATV"],
