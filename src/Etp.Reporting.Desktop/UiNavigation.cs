...
public static class UiNavigationRegistry
{
    ...
    [
        ...
        new("imports", "Imports", "IconImport", "ETP files, Source Inbox, bulk history and registers.", "Import ETP", 40, AccessRole.StoreManager, StatusText: "Duplicate-safe intake"),
        ...
        new("health", "System Health", "IconSettings", "SQL, backup, scheduler and integration status.", "Admin / Settings", 90, AccessRole.Owner, false, true, "Owner only")
    ];
    ...
    [
        ...
        Group("imports-documents", "DOCUMENTS", 40, Item("documents", "Document Repository", "Import ETP")),
