...
public static class ShellRouteRegistry
{
    private static readonly IReadOnlyDictionary<string, ShellRouteDescriptor> Routes =
        ...
        {
            ["Home"] = Route("Home", "home", "Choose a module. Daily work stays on the surface while approved controls remain underneath.", "Home", "Choose a module to begin.", "", "Home"),
            ...
            ["Manual Entry"] = Route("Manual Entry", "dashboard", "Enter approved business-day values that are not supplied by ETP reports.", "Manual Entry", "Start with walk-ins. Additional approved fields will appear here automatically when they are registered in the database.", "Manual Entry ready", "Manual Entry"),
            ...
            ["Registers"] = Route("Registers", "registers", "Create and search audited registers linked to saved documents.", "Digital registers", "Start with the Inward Register and reuse the same approved structure for future register types.", "Registers ready", "Registers"),
            ...
            ["Report Archive"] = Route("Report Archive", "archive", "Open, compare, package and share saved report generations.", "Archive and sharing", "Every archived document and ZIP package is integrity checked and remains tied to its generation.", "Archive ready", "Report Archive"),
