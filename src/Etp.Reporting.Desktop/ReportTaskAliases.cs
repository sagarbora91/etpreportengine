...
public static class ReportTaskAliases
{
    private static readonly IReadOnlyDictionary<string, string[]> aliases = new Dictionary<string, string[]>
    {
        ...
        ["exception-source"] = ["Missing Source Report"],
        ["exception-staff"] = ["Staff Exceptions"],
        ["exception-stock"] = ["Stock Exceptions"],
        ["exception-tender"] = ["Tender Exceptions"],
        ["exception-unmapped"] = ["Unmapped Data"],
        ...
        ["stock-group"] = ["Inventory-Group Report"],
