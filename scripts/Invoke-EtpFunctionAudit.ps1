...
function Write-AuditSummary {
    ...
    $markdown = @(
        ...
        "- Active functions without assigned evidence categories: **$($summary.uncoveredFunctions)**",
        "- Category assignment is traceability only; it does not prove each function or interaction was tested.",
