...
## Corpus Check
- 340 files · ~411,836 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8510 nodes · 17673 edges · 380 communities (276 shown, 104 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 759 edges (avg confidence: 0.85)
...
Cohesion: 0.00
Nodes (289): Acrobat, Acrobat7, ADBE_JSConsole, ADBE_JSDebugger, _addNamespacePrefix(), AddSilentPrint, AddViewerPreferences, AdjustData (+281 more)

### Community 1 - "pdf.min.js"
Cohesion: 0.02
Nodes (70): addNativeFontFace(), BaseException(), BaseShadingPattern, bind(), bytesToString(), CMYK_HTML(), CMYK_RGB(), composeSMaskBackdrop() (+62 more)
...
### Community 6 - "has"
Cohesion: 0.04
Nodes (24): add(), addPdfFont(), adjustMapping(), Catalog, addPageDict(), clean(), _collectJS(), fetchAsync() (+16 more)

### Community 7 - "create"
Cohesion: 0.07
Nodes (71): demo, e4, e5, e6, e7, require, verified, bridge (+63 more)
...
### Community 12 - ".get"
Cohesion: 0.02
Nodes (66): accept(), addNode(), Annotation, ButtonWidgetAnnotation, ChoiceWidgetAnnotation, CircleAnnotation, decodeString(), Dict (+58 more)
...
### Community 18 - ".push"
Cohesion: 0.03
Nodes (61): #a(), addChildren(), addString(), AppearanceStreamEvaluator, bezierBoundingBox(), Border, buildHuffmanTable(), CFFFDSelect (+53 more)

### Community 19 - "create"
Cohesion: 0.05
Nodes (45): addHex(), BinaryCMapStream, appendIfJavaScriptDict(), create(), getInt(), createBuiltInCMap(), decrypt(), expectInt() (+37 more)
...
Cohesion: 0.03
Nodes (21): BaseLocalCache, _cache(), ColorSpace, CompiledFont, createFromArray(), getCached(), getSubroutineBias(), incrementCachedImageMaskCount() (+13 more)
...
### Community 28 - ".onSymbolDictionary"
Cohesion: 0.24
...
### Community 33 - "WorkbookSnapshot"
Cohesion: 0.17
Nodes (14): IReadOnlyList, WorkbookLayoutNormalization, WorkbookLayoutNormalizer, CancellationToken, IReadOnlyList, Task, IWorkbookReader, WorkbookCell (+6 more)
...
### Community 40 - ".getTextContent"
Cohesion: 0.05
Nodes (17): JpegStream, JpxStream, Page, parseCff(), addFakeSpaces(), appendEOL(), applyInverseRotation(), buildTextContentItem() (+9 more)
...
### Community 44 - ".compile"
Cohesion: 0.15
Nodes (11): buildAddOperation(), buildMinOperation(), buildMulOperation(), buildSubOperation(), createDict(), emptyPrivateDictionary(), parseDict(), parseIndex() (+3 more)
...
### Community 49 - ".i"
Cohesion: 0.03
Nodes (44): _addPixels(), _addPixelsNeg(), ComponentPositionResolutionLayerIterator(), ConnectionSet, createPacket(), #E(), _eatBits(), EffectiveInputPolicy (+36 more)
...
Cohesion: 0.06
Nodes (49): Action, Func, SqlTransaction, CancellationToken, DateOnly, DateTimeOffset, Guid, IReadOnlyList (+41 more)
...
### Community 53 - "v6-etp-wave9-e5-full-chain-acceptance.test.mjs"
Cohesion: 0.21
...
### Community 71 - "SaagarOffDevicePlugin"
Cohesion: 0.16
Nodes (8): android.annotation.SuppressLint, android.content.SharedPreferences, android.net.Uri, androidx.activity.result.ActivityResult, Doc, JSObject, SaagarOffDevicePlugin, com.getcapacitor.annotation.ActivityCallback
...
Cohesion: 0.13
Nodes (6): appendText(), BaseSVGFactory, getCtx(), layout(), PopupElement, TextLayerRenderTask
...
Cohesion: 0.10
Nodes (17): now(), adapters, authority(), bindingA, bindingB, e3Engine, e3Orchestrator, e4Engine (+9 more)
...
### Community 96 - "Window"
Cohesion: 0.05
Nodes (48): RoutedEventArgs, ApplicationStatus, ConnectionResult, ConnectionStatus, ConnectionStringInput, DiagnosticsGrid, ExportExcelButton, ImportPanel (+40 more)
...
### Community 118 - "ReportingQueryScope"
Cohesion: 0.26
...
### Community 158 - "etp-retail-profile.js"
Cohesion: 0.47
...
Cohesion: 0.14
Nodes (13): @babel/core, @babel/preset-env, @capacitor/cli, description, devDependencies, @babel/core, @babel/preset-env, @capacitor/cli (+5 more)
...
### Community 169 - "CanonicalContractsTests.cs"
Cohesion: 0.17
Nodes (9): Etp.Reporting.Domain.Tests, Etp.Reporting.Domain.Sales, Etp.Reporting.Domain.Periods, DateOnly, ComparisonPeriod, DateRange, IComparisonPeriodPolicy, Fact (+1 more)
...
Cohesion: 0.18
Nodes (6): Etp.Reporting.Reporting, Etp.Reporting.Reporting.Tests, string, SqlReportingQueries, Fact, OpenXmlReportExporterTests
...
### Community 198 - "v6-etp-e4-authority-intake.test.mjs"
Cohesion: 0.32
...
Cohesion: 0.08
Nodes (29): annotationGlobals(), applyTransform(), cancelAllRequests(), checkFirstPage(), checkLastPage(), createGlobals(), ensure(), getAxialAlignedBoundingBox() (+21 more)
...
### Community 209 - "etp-foundation-status.js"
Cohesion: 0.28
...
### Community 229 - "PDFWorkerStreamReader"
Cohesion: 0.05
Nodes (7): BaseShading, BehaviorOverride, ExData, PDFWorkerStreamReader, Traverse, Ui, XFAAttribute
...
### Community 244 - "SaagarKeystorePlugin"
Cohesion: 0.24
Nodes (6): android.content.Context, SaagarKeystorePlugin, SaagarSecurityPlugin, com.getcapacitor.annotation.CapacitorPlugin, com.getcapacitor.Plugin, javax.crypto.SecretKey
...
### Community 274 - "etp-verified-presentation.js"
Cohesion: 0.38
...
### Community 370 - "get"
Cohesion: 0.09
Nodes (8): AnnotationElementFactory, ColorManager, get(), getEditableAnnotation(), has(), LinkAnnotationElement, render(), setAttributes()
...
### Community 376 - "Etp.Reporting.Desktop"
Cohesion: 0.40
Nodes (3): Etp.Reporting.Desktop, Application, App

### Community 391 - "StoreDb"
Cohesion: 0.36
Nodes (3): android.database.sqlite.SQLiteOpenHelper, Override, StoreDb
...
### Community 402 - "etp-foundation-status.test.mjs"
Cohesion: 0.60
Nodes (4): coverage(), input(), receipt(), scope

### Community 405 - "phase6h1-etp-analytics-presentation.test.mjs"
Cohesion: 0.40
...
### Community 451 - ".toString"
Cohesion: 0.01
Nodes (54): addTopLevelNode(), applyAssist(), Arc, ariaLabel(), BooleanElement, Br, Button, calculationOrderIds() (+46 more)

## Knowledge Gaps
- **836 isolated node(s):** `fs`, `path`, `BUILD_IDENTITY`, `ANDROID_PKG_DIR`, `MANIFEST` (+831 more)
...
- **Why does `TemplateNamespace` connect `TemplateNamespace` to `pdf.worker.min.js`, `.getTextContent`, `.get`, `PDFImage`, `etp-operational-store.js`?**
