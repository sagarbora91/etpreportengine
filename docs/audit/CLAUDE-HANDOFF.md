...
|---|---|---|
| 1 — Data truth | `phase-1/data-truth`, application baseline `d1e7c48`; Claude audit `e1ef5f3` | CLOSED. 790 corpus lines, 759 invoices, 3,955 movements, 25 monthly matches. |
| 2 — Evening reports | `phase-2/evening-reports`, `9241e26` | REOPENED by audit `1e4cd97`. Code `9241e26` was pushed. Its report recorded 679 passing tests. |
| 3 — Touch shell | `phase-3/touch-shell`, `12f108a`, includes Phase 2 | REOPENED by audit `2fc3846`. Code `12f108a` was pushed; recorded 680 passing tests. |
| 4 — Security/operations | `phase-4/security-operations`, `df35d90` | REOPENED by audit `1268c2b`. Separate, unpublished branch with merge/deployment blockers. |
