...
The embedded product version remains 1.8.8+d24a525; r11 is the immutable candidate label identified by hashes and source snapshot. Current evidence documentation was updated after packaging; runtime source must match the archived manifest. Candidates remain local and were not pushed. No production deployment occurred.
